...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="../../index2.html"><b>SIM</b> PARFUM</a><br>
        <a><?php
    ...
    <div class="login-box-body">
      ...
      <form action="{{ route('login') }}" method="POST" autocomplete="off">
        ...
        <div class="form-group has-feedback">
          <input id="text" type="text"  placeholder="Enter your Username" class="form-control" name="email" value="{{ old('email') }}" required autofocus>
          @if ($errors->has('email'))
      ...
      <center>
      <!--<a href="https://richperfumery.com/richperfumery_1.apk" class="btn btn-success btn-xs">Download APK 2</a></center>-->
      <a href="https://richperfumery.com/richperfumery(new).apk" class="btn btn-danger btn-xs">Download APK (NEW)</a></center>

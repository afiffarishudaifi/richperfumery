...
<div class="content">
	<div class="panel panel-flat">
	    ...
	    <div class="panel-body">
	    	...
	    	<input type="hidden" name="id_komposisi" value="">
        	...
        	<div class="col-sm-6">
        		...
        		<div class="form-group">
        			...
        			<div class="col-sm-8">
        				<input type="text" name="jumlah_komposisi" class="form-control harga number-only" value="" required>
        			</div>
        		</div>
        ...
        <div class="col-sm-12 form-group">
        	...
        	<br><a href="#" class="btn btn-success" style="margin-bottom: 1%;" id="btn_tambah_item">Tambah</a></div>
        	{{-- <div class="col-sm-12 ">  --}}
...
@section('js')
  ...
  $('#barang').on('change',function(e){
	...
	function edit_table(id){
		...
		console.log(id);
		var op = '<option>'+id_barang+'</option>'
		$("#kode_a").val(id);
		$("#barang").html(op);
		$("#nama").val(nama);
		$("#jumlah").val(jumlah);

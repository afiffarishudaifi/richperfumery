  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="box">
        ...
        <a href="{{url('pembelian_tambah')}}" style="margin-bottom:20px;margin-left:10px;" class="card-body-title"><button class="btn btn-primary"><i class="fa  fa-plus-square-o"></i> Tambah</button></a>
        <!-- /.box-header -->

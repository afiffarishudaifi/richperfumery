    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title">{{ $data['judul'] }} Belanja Barang</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">

          <form role="form" class="form_belanja" action="{{url('pembelian_simpan')}}" method="post">
            ...
            <div class="box-body">
              <div class="form-group col-md-12 " style="border:1px solid black;">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                      <label for="exampleInputPassword1">Gudang Penerima</label>
                      <select name="id_gudang" class="form-control" style="width: 100%;" required="">  
                      </select>
                    </div>
                </div>
              </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    if(id_pembelian != ''){
      ...
      if(id_gudang != ''){
        $("[name=id_gudang]").html('<option value="'+id_gudang+'">'+nama_gudang+'</option>')
      }

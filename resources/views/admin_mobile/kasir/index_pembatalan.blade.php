...
@section('title', 'Pembatalan Penjualan')
          ...
          <table id="datatable1" class="table table-bordered table-striped">
            <thead>
              <tr>
                ...
                <th style="width:30%">Dibatalkan Oleh</th>
                <th>Action</th>
              </tr>
            </thead>
            <tbody>
...
$("#btn_popupinfo_simpan").click(function(){
    ...
    var url = "<?= url('kasir_cetak')?>"+"/"+id_kasir;
    console.log(url);
    if(keterangan != ''){
      $.ajax({
        url: "{{ url('kasir_simpan_infocetak') }}",
        type: 'post',
        dataType: 'json',
        headers : {

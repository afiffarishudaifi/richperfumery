  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <a href="{{url('pengiriman')}}" style="margin-left: 10px;margin-top: 10px;" class="btn btn-xs btn-primary">Kembali</a>
        ...
        @php echo '<a  style="margin-bottom:20px;margin-left:10px;" class="card-body-title btn btn-primary btn_tambah"><i class="fa  fa-plus-square-o"></i> Tambah</a>';
        if ($gudang['status'] == 0) {
        ...
        if ($gudang['status'] == 0) {
         ...
         <a  style="margin-bottom:20px;margin-left:10px;" id="btn_kirim_se" class="card-body-title btn btn-success  btn_kirim_se"><i class="fa  fa-check"></i> Kirim Semua Barang</a>

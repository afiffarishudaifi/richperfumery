    ...
    <div class="col-md-12">
      <div class="box box-primary">
            ...
            <tbody>
             ...
             <tr>
              ...
              <tr>
                <td>Pembayaran</td>
                <td>
                    <?php $carabayar = \Config::get('constants.carabayar.'.$data['data']['carabayar']);
                    echo "<span>".$carabayar."</span>";
                    ?>
                </td>
              </tr>
              <tr>
                <td>Uang Muka</td>
                <td><input type="hidden" name="td_uangmuka" class="form-control text-right number-only" value="{{$data['data']['uang_muka']}}">
        ...
        <div class="box-footer">
          <a href="{{url('pembelian')}}" class="btn btn-md btn-warning"><span class="glyphicon glyphicon-arrow-left"></span> Kembali</a>
        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    $('[name=id_penyedia]').select2({
            ...
            ajax: {
                url: '{{url('pembelian_get_penyedia')}}',
                dataType: 'json',

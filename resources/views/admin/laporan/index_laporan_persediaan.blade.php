...
<section class="content col-md-6">
  <div class="box">
    ...
    <div class="box-body">
      <form enctype="" class="form form_filter form_laporanpersediaan" target="_blank" action="{{url('laporanpersediaan_cetak')}}" autocomplete="off">
...
$(document).ready(function() {
  ...
  $('#jenis').change(function(){
    if (this.value == 2){
      $('#wrapper-range-tanggal').hide()
    }else{
      $('#wrapper-range-tanggal').show()
    };
  })
  ...
  $('[name=barang]').select2({
            placeholder: "--- Pilih ---",
            ajax: {
                url: '{{url('laporanpersediaan_get_barang')}}',
                dataType: 'json',
 ...
 $('#btn_excel').validator().on('click', function(e){
    if(!e.isDefaultPrevented()){
      ...
      var jenis = $('[name=jenis] :selected').val();
    
      if (jenis == 1) {
        window.open("{{url('laporanpersediaan_excel')}}/"+gudang+"/"+tanggal+"/"+tanggal2+"/"+barang,'_blank'); 
      }else if(jenis == 2){
        window.open("{{url('laporanpersediaan_detail_excel')}}/"+gudang+"/"+barang+"/"+jenis,'_blank');
      }
 ...
 $('#btn_filter').on('click',function(e){
    if(!e.isDefaultPrevented()){
      ...
      if (jenis == 1) {
        window.open("{{url('laporanpersediaan_hasil')}}/"+gudang+"/"+tanggal+"/"+tanggal2+"/"+barang,'_blank'); 
      }else if(jenis == 2){
        window.open("{{url('laporanpersediaan_detail_hasil')}}/"+gudang+"/"+barang+"/"+jenis,'_blank');
      }

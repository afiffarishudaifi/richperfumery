<?php $hal = 'laporanpembatalandetail'; ?>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">Laporan Pembatalan Detail</h3>
            ...
            <div class="box-body">
                <form enctype="" class="form form_filter form_laporanpembelian" target="_blank"
                    action="{{ url('laporanpembatalandetail_cetak') }}" autocomplete="off">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                <button type="button" style="margin-top: 25px; width: 75px;" class="btn btn-warning"
                                    id="btn_filter_pembatalan"><b><i class="fa  fa-search"></i></b> Filter</button>
                                <button type="submit" style="margin-top: 25px; width: 75px;" class="btn btn-success"
                                    id="btn_cetak_pembatalan"><b><i class="fa fa-file-pdf-o"></i></b> PDF</button>
                                <button type="button" style="margin-top: 25px; width: 75px;" class="btn btn-primary"
                                    id="btn_excel_pembatalan"><b><i class="fa  fa-file-excel-o"></i></b> Excel</button>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <script type="text/javascript">
        ...
        $('#btn_excel_pembatalan').validator().on('click', function(e) {
            if (!e.isDefaultPrevented()) {
                ...
                window.open("{{ url('laporanpembatalandetail_excel') }}/" + gudang + "/" + tanggal + "/" + tanggal2 + "/" + kategori, '_blank');
            }
        });
        ...
        $('#btn_filter_pembatalan').validator().on('click', function(e) {
            if (!e.isDefaultPrevented()) {
                ...
                window.open("{{ url('laporanpembatalandetail_hasil') }}/" + gudang + "/" + tanggal + "/" + tanggal2 +
                    "/" + kategori, '_blank');
            }
        });

...
class Pdf extends PDF_MC_Table{
	...
	public $def_width = 210, $def_height = 350;
	...
	function Header(){
		...
		if($this->PageNo() != 0){
			...
			$this->SetWidths(array(10, 20, 20, 20, 60, 40, 20, 25, 25, 25, 25, 30, 20));
	        $this->SetAligns(array('C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C'));
	        $this->Row(array("NO.", 'NO.NOTA', 'TANGGAL', "KODE BARANG", "NAMA PARFUM", "NAMA GUDANG", "STOCK AWAL", "PENGIRIMAN HARI INI", "RETUR HARI INI", "STOK AKHIR", "HARGA", "KET.", "STATUS"));

	        $this->setFont('arial','',8);
			$this->SetWidths(array(10, 20, 20, 20, 60, 40, 20, 25, 25, 25, 25, 30, 20));
	        $this->SetAligns(array('C', 'C', 'C', 'C', 'L', 'L', 'R', 'R', 'R', 'R', 'R', 'L', 'L'));

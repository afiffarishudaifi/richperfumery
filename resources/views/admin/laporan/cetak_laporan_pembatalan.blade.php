...
<table width="100%" border="0">
	...
	<tr>
		<th>Nota Retur</th>
		<th></th>
		<th>Pembatalan Hari ini</th>
		<th>{{($data['pembatalan']['569']['total_barang']=="")?"":format_angka($data['pembatalan']['569']['total_barang'])}}</th>
		<th>{{($data['pembatalan']['571']['total_barang']=="")?"":format_angka($data['pembatalan']['571']['total_barang'])}}</th>
		<th>{{($data['pembatalan']['610']['total_barang']=="")?"":format_angka($data['pembatalan']['610']['total_barang'])}}</th>
		<th>{{($data['pembatalan']['587']['total_barang']=="")?"":format_angka($data['pembatalan']['587']['total_barang'])}}</th>
		<th>{{($data['pembatalan']['594']['total_barang']=="")?"":format_angka($data['pembatalan']['594']['total_barang'])}}</th>
		<th>{{($data['pembatalan']['600']['total_barang']=="")?"":format_angka($data['pembatalan']['600']['total_barang'])}}</th>
		<th>{{($data['pembatalan']['601']['total_barang']=="")?"":format_angka($data['pembatalan']['601']['total_barang'])}}</th>
		<th>{{($data['pembatalan']['602']['total_barang']=="")?"":format_angka($data['pembatalan']['602']['total_barang'])}}</th>
		<th>{{($data['pembatalan']['606']['total_barang']=="")?"":format_angka($data['pembatalan']['606']['total_barang'])}}</th>
		<th>{{($data['pembatalan']['605']['total_barang']=="")?"":format_angka($data['pembatalan']['605']['total_barang'])}}</th>
		<th>{{($data['pembatalan']['607']['total_barang']=="")?"":format_angka($data['pembatalan']['607']['total_barang'])}}</th>
		<th>{{($data['pembatalan']['631']['total_barang']=="")?"":format_angka($data['pembatalan']['631']['total_barang'])}}</th>
		<th>{{($data['pembatalan']['632']['total_barang']=="")?"":format_angka($data['pembatalan']['632']['total_barang'])}}</th>
		<th>{{($data['pembatalan']['633']['total_barang']=="")?"":format_angka($data['pembatalan']['633']['total_barang'])}}</th>
		<th>{{($data['pembatalan']['634']['total_barang']=="")?"":format_angka($data['pembatalan']['634']['total_barang'])}}</th>
	</tr>
	@php
	$d_569 = (float)$data['stokawal']['569']['total_barang']-(float)$data['pembatalan']['569']['total_barang'];
	$d_571 = (float)$data['stokawal']['571']['total_barang']-(float)$data['pembatalan']['571']['total_barang'];
	$d_610 = (float)$data['stokawal']['610']['total_barang']-(float)$data['pembatalan']['610']['total_barang'];
	$d_587 = (float)$data['stokawal']['587']['total_barang']-(float)$data['pembatalan']['587']['total_barang'];
	$d_594 = (float)$data['stokawal']['594']['total_barang']-(float)$data['pembatalan']['594']['total_barang'];
	$d_600 = (float)$data['stokawal']['600']['total_barang']-(float)$data['pembatalan']['600']['total_barang'];
	$d_601 = (float)$data['stokawal']['601']['total_barang']-(float)$data['pembatalan']['601']['total_barang'];
	$d_602 = (float)$data['stokawal']['602']['total_barang']-(float)$data['pembatalan']['602']['total_barang'];
	$d_606 = (float)$data['stokawal']['606']['total_barang']-(float)$data['pembatalan']['606']['total_barang'];
	$d_605 = (float)$data['stokawal']['605']['total_barang']-(float)$data['pembatalan']['605']['total_barang'];
	$d_607 = (float)$data['stokawal']['607']['total_barang']-(float)$data['pembatalan']['607']['total_barang'];
	$d_631 = (float)$data['stokawal']['631']['total_barang']-(float)$data['pembatalan']['631']['total_barang'];
	$d_632 = (float)$data['stokawal']['632']['total_barang']-(float)$data['pembatalan']['632']['total_barang'];
	$d_633 = (float)$data['stokawal']['633']['total_barang']-(float)$data['pembatalan']['633']['total_barang'];
	$d_634 = (float)$data['stokawal']['634']['total_barang']-(float)$data['pembatalan']['634']['total_barang'];
	@endphp
	<tr>
		<th style="border-style: none;"></th>
		<th style="border-style: none;"></th>
...
<div>
	<table  width="40%" height="60%" align="left">
		...
		?>
		<tr>
			<th width="35%">Pembatalan Tunai{{$d->name}}</th>

              ...
              <div class="col-md-12 form-horizontal form-group" style="border:1px solid black;">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <select class="form-control" name="gudang" style="width: 100%;" required="">
                      </select>
                    </div>
                  </div>
                  <div class="form-group">
        ...
        if(respon.length > 0){
          for(i in respon){
            ...
            table_barang.row.add(['<div><center></center></div>',
              ...
              '<div id="list_jumlah_terima'+respon[i].id+'"> <input type="text" class="form-control text-right number-only" id="popup_jumlah_terima'+respon[i].id+'" name="tabel_jumlah_terima[]" onkeyup="keyup_jumterima($(this),'+respon[i].id+','+respon[i].jumlah+'); maksimal($(this))" min="0" max="'+respon[i].jumlah+'" value="'+respon[i].jumlah_terima+'"> <p class="text-right" id="help_popup_jumlahterima'+respon[i].id+'">'+format_angka(parseInt(respon[i].jumlah_terima))+'</p></div>'+

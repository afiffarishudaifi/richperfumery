              ...
              <div class="col-md-12 form-horizontal form-group" style="border:1px solid black;">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" type="text" name="no_faktur_beli" placeholder="Tanggal" value="{{$data['data']['nomor']}}" disabled="" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1" class="col-md-4">Tanggal Input</label>
                    <div class="col-md-8">
                      <input class="form-control" type="text" name="tanggal_beli" placeholder="Tanggal" value="{{$data['data']['tanggal']}}" disabled="" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1" class="col-md-4">Tanggal Faktur</label>
                    <div class="col-md-8">
                      <input class="form-control" type="text" name="tanggal_faktur_beli" placeholder="Tanggal" value="{{$data['data']['tanggal_faktur']}}" disabled="" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1" class="col-md-4">Penyedia</label>
                    <div class="col-md-8">
                      <input type="text" name="penyedia_beli" class="form-control" value="{{$data['data']['nama_penyedia']}}" disabled="">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input class="form-control" type="text" name="tanggal_penerimaan" placeholder="Tanggal" value="{{($data['data']['tanggal_penerimaan'] == '') ? date('d-m-Y'):$data['data']['tanggal_penerimaan']}}" disabled="" />
                    </div>
                  </div>
                  <!-- <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <input type="text" name="gudang" class="form-control" value="{{$data['data']['nama_gudang']}}" disabled="">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1" class="col-md-4">Status Penerimaan</label>
                    <div class="col-md-8">
                      <?php $status_penerimaan = \Config::get('constants.status_penerimaan'.$data['data']['status_penerimaan']);?>
                      <input type="text" name="status_penerimaan" class="form-control" value="{{$status_penerimaan}}" disabled="">
                    </div>
                  </div>
                </div>
              </div>
        ...
        if(respon.length > 0){
          for(i in respon){
            ...
            table_barang.row.add(['<div><center></center></div>',
              ...
              '<div id="list_jumlah_terima'+respon[i].id+'"> <input type="text" class="form-control text-right number-only hide" id="popup_jumlah_terima'+respon[i].id+'" name="tabel_jumlah_terima[]" onkeyup="keyup_jumterima($(this),'+respon[i].id+','+respon[i].jumlah+'); maksimal($(this))" min="0" max="'+respon[i].jumlah+'" value="'+respon[i].jumlah_terima+'"> <p class="text-right" id="help_popup_jumlahterima'+respon[i].id+'">'+format_angka(parseInt(respon[i].jumlah_terima))+'</p></div>'+
              ...
              '<input type="hidden" name="tabel_jumlahterima[]" id="tabel_jumlahterima'+respon[i].id+'" value="'+respon[i].jumlah_terima+'">'+

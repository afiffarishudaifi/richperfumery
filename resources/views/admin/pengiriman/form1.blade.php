          ...
          <div class="modal-body">
            ...
            <input type="hidden" id="crud" name="crud" value="">
              ...
              <div class="form-group">
                ...
                <div class="input-group col-sm-8">
                  <!-- <span class="input-group-addon"><i class="fa  fa-user"></i></span> -->
                  <select name="gudang_awal" id="gudang_awal" class="form-control select2" style="width: 100%; height:100%">
            ...
            <div class="form-group">
              ...
              <div class="input-group col-sm-8">
                <select name="tujuan" id="tujuan" class="form-control select2" style="width: 100%; height:100%">
            ...
            <div class="form-group">
              ...
              <div class="input-group col-sm-8">
                <select name="pengiriman" id="pengiriman" class="form-control select2" style="width: 100%; height:100%">

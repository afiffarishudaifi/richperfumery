        ...
        <div class="modal-header">
          ...
          <div class="modal-body">
            <form class="form-horizontal" autocomplete="off">
              <input type="hidden" name="store_id_table">
              ...
              <div class="form-group" id="group-produk">
                ...
                <div class="col-sm-9">
                  ...
                  <!-- <input type="text" name="popup_produk" id="popup_produk_input" class="form-control">
                  <input type="text" name="popup_namaproduk"  id="popup_namaproduk" class="form-control"> -->
                </div>
              </div>

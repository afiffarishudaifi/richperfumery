          ...
          <div class="modal-body">
            <form class="form-horizontal" autocomplete="off">
              ...
              <!-- <div class="form-group pull-right">
                <div class="col-sm-12">
                <button type="button" class="btn btn-default" id="btn_redeem_not">Redeem</button>
                <button type="button" class="btn btn-primary" id="btn_redeem_check">Not Redeem</button>
                </div>
              </div> -->
              <div class="form-group" id="group-produk">
                <label class="col-sm-3">Produk</label>
                <div class="col-sm-9">
                  <select class="form-control select-search" name="popup_produk" id="popup_produk_select" style="width: 100%;">
              ...
              <div class="form-group" id="group-harga">
                <label class="col-sm-3">Harga Jual</label>
                <div class="col-sm-9">
                  <input type="text" name="popup_harga" class="form-control text-right number-only" readonly="">
                  <p class="help-block pull-right" id="help_popup_harga"></p>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-3">Poin</label>
                <div class="col-sm-9">
                  <input type="text" name="popup_poin" id="popup_poin" class="form-control text-right">
                  <p class="help-block text-right help_popup_poin" id="help_popup_poin"></p>
                </div>
              </div>
            </form>
          </div>

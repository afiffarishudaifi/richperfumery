      ...
      <div class="modal-header">
        ...
        <form class="form-horizontal" data-toggle="validator" method="post">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="satuan_satuan" class="col-sm-2 control-label">Kategori</label>

              <div class="col-sm-8">
                 <select class="form-control" name="popup_produk" id="popup_produk" style="width: 100%;">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                ...
                <p class="help-block pull-right" id="help_block_poin">Rp. 0</span>
                <span class="help-block with-errors"></span>
              </div>
            </div>
            <!-- /.form-group -->
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary btn-save"><i class="fa fa-floppy-o"></i> Simpan </button>
          </div>
        </div>

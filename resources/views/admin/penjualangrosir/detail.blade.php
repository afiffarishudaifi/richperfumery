              ...
              <div class="form-group col-md-12 " style="border:1px solid black;">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" name="id_pelanggan" class="form-control" value="{{$data['data']['nama_pelanggan']}}" disabled="">
                  </div>
                  <div class="form-group col-md-6">
                   ...
                   <div class="form-group col-md-6">
                    ...
                    <input type="text"  name="" class="form-control" value="" placeholder="Grosir" disabled="">
                  </div>
                  <!-- <div class="form-group col-md-6">
           ...
           <table class="table table-bordered table-form">
            <tbody>
             ...
             <tr>
               ...
               <tr>
                <td>Potongan</td>
                <td><input type="hidden" name="td_diskon" class="form-control number-only text-right" value="{{($data['data']['td_potongan']== '') ? '0':$data['data']['td_potongan']}}">
              ...
              <tr>
                <td>Ongkos Kirim</td>
                <td><input type="hidden" step="0.01" min="0" name="td_ongkir" id="td_ongkir" class="form-control text-right number-only" value="{{($data['data']['td_ongkir']== '') ? '0':$data['data']['td_ongkir']}}">
              ...
              <tr>
                <td>Pembayaran</td>
                <td><select class="form-control select2" name="carabayar" style="width: 100%;" disabled="">
                       <?php
...
function get_edit(id){
  $.ajax({
      ...
      success: function(respon){
        if(respon.length > 0){
          for(i in respon){
            var nama_barang = respon[i].kode_barang+" || "+respon[i].nama_barang;
            table_barang.row.add(['<div><center></center></div>',
              '<div id="list_barang'+respon[i].id+'">'+nama_barang+'</div>',
              ...
              '<input type="hidden" name="tabel_namabarang[]" id="tabel_namabarang'+respon[i].id+'" value="'+nama_barang+'">'+
...
function netto(){
  ...
  if($('select[name=pajak]').val()==1){
    ...
    // console.log(ongkir+"/"+ppn+"/"+total+"/u/"+uangmuka+"/"+diskon);
